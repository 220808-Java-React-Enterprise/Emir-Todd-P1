    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try{
            ...
            if (path[3].equals("list_type")){
                ...
                //resp.getWriter().write(mapper.writeValueAsString(principal.getId()));
                //resp.getWriter().write(mapper.writeValueAsString(request.getAuthor_id()));
                    resp.setContentType("application/json");
                ...
                } else if(principal.getId().equals(reimbursement.getAuthor_id())){
                    resp.getWriter().write(mapper.writeValueAsString(reimbursement));
                }else{
